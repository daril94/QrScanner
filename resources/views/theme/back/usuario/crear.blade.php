            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-7">
                    <div class="card-body">
                        ...
                        <p class="login-card-description text-center" style="font-size: 24px; font-weight: 700">Registra una nueva cuenta</p>
                        <form method="POST" action="{{ route('admin.guardar') }}">
                            @csrf
                            <div class="form-group">
                                <label for="name" class="sr-only">Nombre</label>
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                    name="nombre" value="{{ old('name') }}" required placeholder="Nombres">
                                @error('name')
                            ...
                            <input name="" id="register" class="btn btn-block login-btn btn-primary mb-4"  style="font-size: 18px; font-weight: 700" type="submit"
                                value="Registrar">
                        </form>
